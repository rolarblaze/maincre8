...
export const formConfig: {
  ...
  digitalMarketing: {
    ...
    constructPayload: (payload) => ({
      ...
      campaign_duration: convertToString(payload.digitalCampaignDur),
  ...
  brandDesign: {
    ...
    constructPayload: (payload) => ({
      ...
      value_proposition: convertToString(payload.brandUSP),
  ...
  AllInOne: {
    ...
    constructPayload: (payload) => ({
      ...
      uploaded_style_guide: convertToString(payload.allInOneBrandColorDocument),
      reference_brands: convertToString(payload.allInOneBrandAdmire),
      primary_platform: convertToString(payload.allInOnePlatform),
      challenges: convertToString(payload.allInOneExistingMarket),
      ...
      key_deliverables: convertToString(payload.allInOneKeyDeliverables),
      email_marketing_goals: convertToString(payload.allInOneMainGoal),
      uploaded_brief: convertToString(payload.document),
    }),
  },
