...
const ServiceRecommendModal = () => {
  return (
    <div className="max-w-[34rem] max-h-[20rem] w-full h-full flex flex-col justify-between rounded-lg bg-white px-6 py-6">
      <ModalCheckIcon />
      ...
      <Link href={"/dashboard/overview"} className="flex gap-2 text-primary500">
