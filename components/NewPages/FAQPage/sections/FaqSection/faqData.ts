...
export const newFAQData = [
  {
    ...
    labels: [labels.onbboarding, labels.marketing],
  },
  {
    ...
    labels: [labels.bundles, labels.marketing],
  },
  {
    ...
    labels: [labels.support, labels.projectManagement],
  },
  {
    ...
    labels: [labels.bundles, labels.marketing, labels.payment],
  },
  {
    ...
    labels: [labels.bundles, labels.content, labels.marketing],
  },
  {
    ...
    labels: [labels.bundles, labels.support, labels.projectManagement],
  },
  {
    question: "Can SellCrea8 handle urgent or last-minute tasks",
    answer:
    ...
    labels: [labels.content, labels.marketing, labels.projectManagement],
  },
  {
    ...
    labels: [labels.onbboarding, labels.payment],
  },
];
