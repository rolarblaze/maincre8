...
import CountryCurrencyInput from "@/components/Dashboard/BusinessBriefForm/CountryCurrencyInput";
  ...
  return (
    <section className="full-width flex justify-center bg-grey50 px-5 pb-[6.3rem] pt-10">
      <form
        ...
        className="w-full max-w-[43rem] space-y-8 bg-white py-8 px-[3.4rem] rounded-[10px]"
      >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <InputField
              ...
              error={
                touched.dislikeDigitalPrescence &&
                errors.dislikeDigitalPrescence
              }
              onChange={handleChange}
              onBlur={handleBlur}
            />
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium leading-6 text-grey900">
