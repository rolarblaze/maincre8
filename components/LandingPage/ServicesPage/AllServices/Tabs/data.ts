export const Services = [
  {
    ...
    title: "Guaranteed Brand Uniformity",
    subTitle: "Achieve reliable, on-brand results every time with SellCrea8",
    content: [
      {
  ...
  {
    tab: "Create Briefs",
    title: "Effortless Brief Creation",
    subTitle: "Quickly assemble your creative tasks with SellCrea8",
    content: [
      {
        heading: "Working with Our Team",
        description:
  ...
  {
    tab: "Organize and Prioritize",
    title: "Manage Project Priorities",
    subTitle: "Effortlessly track and adjust project priorities with SellCrea8",
    content: [
      {
  ...
  {
    tab: "Unlimited Revisions",
    title: "Unlimited Revisions",
    subTitle: "Get the perfect results with unlimited revisions",
    content: [
      {
  ...
  },
  {
    tab: "Ready to Use",
    title: "Ready to Use",
    subTitle: "We have every file format you need available",
    content: [
      {
  ...
  },
  {
    ...
    title: "Integration",
    subTitle:
      "Our Zoho  Integration allows you to start and manage all your projects directly from your favorite apps",
    content: [
      {
