...
const Tabs: React.FC<TabsProps> = ({
  ...
  return (
    <div className="flex items-center gap-3 md:justify-between md:px-6 overflow-x-auto w-full md:w-auto">
      <div className="flex items-center gap-1 border-b border-grey200 overflow-x-auto noScrollbar">
        {tabs.map((tab) => (
          <div
            key={tab.name}
            className={`flex items-center gap-2 p-4 text-nowrap cursor-pointer ${
              activeTab === tab.name
